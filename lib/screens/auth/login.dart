            ...
            children: [
              const Text(
                ...
                style: TextStyle(
                  ...
                  color: Color.fromARGB(
                      255, 255, 255, 255), // White text for better contrast
                ),
              ),
              const Text(
                ...
                style: TextStyle(
                  ...
                  fontWeight: FontWeight.bold,
                  color: Color.fromARGB(
                      255, 211, 211, 211), // White text for better contrast
                ),
              ),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  minimumSize: const Size(
                      double.infinity, 50), // Full width, 50px height
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  minimumSize: const Size(
                      double.infinity, 50), // Width (full) and Height (60px)
                  padding: const EdgeInsets.symmetric(vertical: 14),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(11),
