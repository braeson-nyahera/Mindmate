            ...
            itemBuilder: (BuildContext context) {
              return [
                PopupMenuItem<String>(
                  enabled:
                      false, // Prevents this wrapper item from being selectable
                  child: ConstrainedBox(
                    constraints: const BoxConstraints(
                      maxHeight:
                          290, // Dropdown grows dynamically but stops at . . .
                    ),
                    child: SingleChildScrollView(
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
              ...
              child: Row(
                ...
                children: [
                  ...
                  const Icon(Icons.arrow_drop_down,
                      color: Color(0xFF2D5DA1), size: 30),
                ],
              ),
            ),
          ),
        ...
        builder: (context, snapshot) {
          ...
          var tutorsList = snapshot.data!.docs.where((doc) {
            ...
            bool matchesSearch = searchQuery.isEmpty ||
                (tutorData['subjects'] as List).any(
                    (subject) => subject.toLowerCase().contains(searchQuery)) ||
                (tutorData['specialty']?.toLowerCase().contains(searchQuery) ??
                    false);
          ...
          return Padding(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                var tutorData =
                    tutorsList[index].data() as Map<String, dynamic>;
